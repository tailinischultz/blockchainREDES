...
export class MetadataSignature extends jspb.Message {
  ...
  getIdentifierHeader(): Uint8Array | string;
  getIdentifierHeader_asU8(): Uint8Array;
  getIdentifierHeader_asB64(): string;
  setIdentifierHeader(value: Uint8Array | string): void;
...
export namespace MetadataSignature {
  export type AsObject = {
    ...
    identifierHeader: Uint8Array | string,
  }
}

export class IdentifierHeader extends jspb.Message {
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): IdentifierHeader.AsObject;
  static toObject(includeInstance: boolean, msg: IdentifierHeader): IdentifierHeader.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: IdentifierHeader, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): IdentifierHeader;
  static deserializeBinaryFromReader(message: IdentifierHeader, reader: jspb.BinaryReader): IdentifierHeader;
}

export namespace IdentifierHeader {
  export type AsObject = {
    identifier: number,
