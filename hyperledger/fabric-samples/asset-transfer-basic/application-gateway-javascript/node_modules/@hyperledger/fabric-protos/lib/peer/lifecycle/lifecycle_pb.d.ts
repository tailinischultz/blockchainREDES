...
export class CheckCommitReadinessResult extends jspb.Message {
  ...
  getMismatchesMap(): jspb.Map<string, CheckCommitReadinessResult.Mismatches>;
  clearMismatchesMap(): void;
  serializeBinary(): Uint8Array;
...
export namespace CheckCommitReadinessResult {
  export type AsObject = {
    ...
    mismatchesMap: Array<[string, CheckCommitReadinessResult.Mismatches.AsObject]>,
  }

  export class Mismatches extends jspb.Message {
    clearItemsList(): void;
    ...
    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): Mismatches.AsObject;
    static toObject(includeInstance: boolean, msg: Mismatches): Mismatches.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: Mismatches, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): Mismatches;
    static deserializeBinaryFromReader(message: Mismatches, reader: jspb.BinaryReader): Mismatches;
  }

  export namespace Mismatches {
    export type AsObject = {
...
export class QueryApprovedChaincodeDefinitionsArgs extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): QueryApprovedChaincodeDefinitionsArgs.AsObject;
  static toObject(includeInstance: boolean, msg: QueryApprovedChaincodeDefinitionsArgs): QueryApprovedChaincodeDefinitionsArgs.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: QueryApprovedChaincodeDefinitionsArgs, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): QueryApprovedChaincodeDefinitionsArgs;
  static deserializeBinaryFromReader(message: QueryApprovedChaincodeDefinitionsArgs, reader: jspb.BinaryReader): QueryApprovedChaincodeDefinitionsArgs;
}

export namespace QueryApprovedChaincodeDefinitionsArgs {
  export type AsObject = {
  }
}

export class QueryApprovedChaincodeDefinitionsResult extends jspb.Message {
  clearApprovedChaincodeDefinitionsList(): void;
  getApprovedChaincodeDefinitionsList(): Array<QueryApprovedChaincodeDefinitionsResult.ApprovedChaincodeDefinition>;
  setApprovedChaincodeDefinitionsList(value: Array<QueryApprovedChaincodeDefinitionsResult.ApprovedChaincodeDefinition>): void;
  addApprovedChaincodeDefinitions(value?: QueryApprovedChaincodeDefinitionsResult.ApprovedChaincodeDefinition, index?: number): QueryApprovedChaincodeDefinitionsResult.ApprovedChaincodeDefinition;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): QueryApprovedChaincodeDefinitionsResult.AsObject;
  static toObject(includeInstance: boolean, msg: QueryApprovedChaincodeDefinitionsResult): QueryApprovedChaincodeDefinitionsResult.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: QueryApprovedChaincodeDefinitionsResult, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): QueryApprovedChaincodeDefinitionsResult;
  static deserializeBinaryFromReader(message: QueryApprovedChaincodeDefinitionsResult, reader: jspb.BinaryReader): QueryApprovedChaincodeDefinitionsResult;
}

export namespace QueryApprovedChaincodeDefinitionsResult {
  export type AsObject = {
    approvedChaincodeDefinitionsList: Array<QueryApprovedChaincodeDefinitionsResult.ApprovedChaincodeDefinition.AsObject>,
  }

  export class ApprovedChaincodeDefinition extends jspb.Message {
    getName(): string;
    setName(value: string): void;
    ...
    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): ApprovedChaincodeDefinition.AsObject;
    static toObject(includeInstance: boolean, msg: ApprovedChaincodeDefinition): ApprovedChaincodeDefinition.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: ApprovedChaincodeDefinition, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): ApprovedChaincodeDefinition;
    static deserializeBinaryFromReader(message: ApprovedChaincodeDefinition, reader: jspb.BinaryReader): ApprovedChaincodeDefinition;
  }

  export namespace ApprovedChaincodeDefinition {
    export type AsObject = {
      name: string,
      sequence: number,
      version: string,
